 ...
 * 2) текст - посчитать количество вхождений каждого слова. метод, который удаляет знаки препинания
 * 3) текст  - выделить предложения. пр: №1. предложение
 * 4) текст - посчитать количество слов
 */
