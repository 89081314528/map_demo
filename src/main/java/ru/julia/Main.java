...
/**
 * map - отображение
 * главный признак массива - можно обратиться к i элементу, где i - это целое число. В массивах не может быть
 * пропуска элементов
 * В мапе индексом может быть число, строка, класс и т. д. или Обджект, тогда туда можно подставлять все
 * что угодно
